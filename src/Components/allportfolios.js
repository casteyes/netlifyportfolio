...
const portfolios = [
  {
    ...
    paragraph:
      "Web Application that uses the entire MERN stack to create a small social networking enviornment.",
  },
  {
    id: 2,
    category: "React Projects",
    link1: "https://nasaapiproject.netlify.app/",
    link2: "www.github.com",
    icon1: "Website",
    icon2: "Y",
    image: port5,
    ...
    paragraph:
      "Web Application that retrives an image object from the Nasa Api ",
  },
  {
    id: 3,
    ...
    paragraph:
      "Surplus Deficent application made for the non-profit organization ElderSource. Made using C# and ASP.NET with Visual Studio 2019",
  },
  {
    id: 4,
    category: "C#/.NET Projects",
    ...
    paragraph:
      "E-Commerce site for a coffee company. Made using C# and ASP.NET with Visual Studio 2019",
  },
  {
    id: 5,
    category: "React Projects",
    ...
    paragraph:
      "App for tracking daily tasks. Made using React and Visual Studio Code",
  },

  {
    id: 6,
    category: "React Projects",
    link1: "https://expensetrackerproject.netlify.app/",
    link2: "www.github.com",
    icon1: "Website",
    icon2: "Y",
    image: port6,
